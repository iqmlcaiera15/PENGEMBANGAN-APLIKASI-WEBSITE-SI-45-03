    ...
    <form action="{{ route('penjualan.store') }}" method="post">
        <div class="row">
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-5">Tambah Penjualan</h4>
                        @csrf
                        <div class='form-group mb-3'>
                            <label for='kode' class='mb-2'>Kode</label>
                            <input type='text' name='kode' class='form-control @error('kode') is-invalid @enderror'
                                value='{{ $kode_baru ?? old('kode') }}' disabled>
                            @error('kode')
                        ...
                        <div class='form-group'>
                            ...
                            <select name='status' id='status'
                                ...
                                <option @selected(old('status') == 2) value="2">Sukses</option>
                                <option @selected(old('status') == 3) value="3">Gagal</option>
                            </select>
                            @error('status')
                                <div class='invalid-feedback'>
                                    {{ $message }}
