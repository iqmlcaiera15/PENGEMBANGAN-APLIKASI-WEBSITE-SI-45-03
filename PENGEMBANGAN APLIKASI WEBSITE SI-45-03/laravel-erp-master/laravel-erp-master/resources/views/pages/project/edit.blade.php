    ...
    <form action="{{ route('project.update', $item->id) }}" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-12 mb-2">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-5">Edit Project</h4>
                        @csrf
                        @method('patch')
                        ...
                        <div class='form-group mb-3'>
                            <label for='estimasi_harga' class='mb-2'>Estimasi Harga</label>
                            <input type='text' name='estimasi_harga'
                                class='form-control @error('estimasi_harga') is-invalid @enderror'
                                value='{{ $item->estimasi_harga ?? old('estimasi_harga') }}' disabled>
                        ...
                        <div class='form-group mb-3'>
                            <label for='harga_project' class='mb-2'>Harga</label>
                            <input type='text' name='harga_project'
                                class='form-control @error('haga') is-invalid @enderror'
                                value='{{ $item->harga ?? old('harga_project') }}'>
                            @error('haga')
                                <div class='invalid-feedback'>
                                    {{ $message }}
                                </div>
                        ...
                        <div class='form-group'>
                            ...
                            <select name='status' id='status'
                                ...
                                <option @selected($item->status == 0) value="0">Belum Dikerjakan</option>
                                <option @selected($item->status == 1) value="1">Sedang Dikerjakan</option>
                                <option @selected($item->status == 2) value="2">Sudah Selesai</option>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="button" href="javascript:void(0)" class="btn rowAdd btn-success"><i
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <select name='produk_supplier_id[]' id='produk_supplier_id'
                                            ...
                                            @foreach ($data_produk_supplier as $produk)
                                                <option @selected($produk->id == $detail->produk_supplier_id) value='{{ $produk->id }}'>
                                                    {{ $produk->nama }}</option>
                                            @endforeach
                                        </select>
